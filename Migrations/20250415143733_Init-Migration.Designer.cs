...
namespace MedicalCenter.Migrations
{
    ...
    [Migration("20250415143733_Init-Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicalCenter.Model.MedicalCenter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedicalCenter.Model.Appointment", b =>
                {
                    ...
                    b.HasOne("MedicalCenter.Model.MedicalCenter", "MedicalCenter")
                        .WithMany()
            ...
            modelBuilder.Entity("MedicalCenter.Model.Service", b =>
                {
                    b.HasOne("MedicalCenter.Model.Specialization", null)
                        .WithMany("Services")
                        .HasForeignKey("SpecializationId");
                });
            ...
            modelBuilder.Entity("MedicalCenter.Model.Doctor", b =>
                {
                    ...
                    b.HasOne("MedicalCenter.Model.MedicalCenter", null)
                        .WithMany("Doctors")
                        .HasForeignKey("MedicalCenterId");
                });
